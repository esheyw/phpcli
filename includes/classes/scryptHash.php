 ...
 *
 * You can create a new hash for a password by calling scryptHash::hash($password)
 *
 * You can check a password by calling scryptHash::check($password, $hash)
 *
 * @category Security
 * @package  Scrypt
 * @author   Dominic Black <thephenix@gmail.com>
...
abstract class scryptHash
{
     ...
     * @param string $salt     The salt to use, or false to generate a random one
